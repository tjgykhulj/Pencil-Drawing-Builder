...
import com.dell.photodemo.adapter.NavDrawerListAdapter;
import com.dell.photodemo.entity.NavDrawerItem;
...
public class MenuFragment extends Fragment implements OnItemClickListener {
	...
	private void findView(View rootView) {
		...
		for (int i=0; i<3; i++)
			mNavDrawerItems.add(new NavDrawerItem(mNavMenuTitles[i], mNavMenuIconsTypeArray.getResourceId(i, -1)));
